<?php namespace Cvsouth\Amazon\Classes;

define('AWS_API_KEY', config("cvsouth-amazon.api.key"));
define('AWS_API_SECRET_KEY', config("cvsouth-amazon.api.secret"));
define('AWS_ASSOCIATE_ID', config("cvsouth-amazon.id"));
 ...
 * @contributor  Colin South <colin@riseresolution.com>
...
class AmazonECS
{
     ...
     * @see returnType()
     */
    public function search($pattern, $nodeId = null, $sort = null)
    {
    ...
    public function category($category = null)
    {
        if (null === $category)
        {
            return array_key_exists('category', $this->requestConfig) ? $this->requestConfig['category'] : null;
        }
